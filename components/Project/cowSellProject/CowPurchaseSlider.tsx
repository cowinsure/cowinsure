    ...
    <SwiperSlide key={index} className='p-2'>
        ...
        <div className='relative   w-full flex-col h-auto mb-10  justify-center items-center group bg-gray-800 rounded-lg'>
                          ...
                          <div className=' absolute bottom-0 left-0 right-0 z-50  mx-5  overflow-hidden group-hover:overflow-visible '>
                              ...
                              <Link href={`project/cow_page`} className='rounded-b-lg overflow-hidden absolute left-0 cursor-pointer  right-0  invisible bottom-[0%] bg-transparent   group-hover:visible group-hover:bottom-[-31px]    transition-all duration-500
