...
import TeamSection from '@/components/AboutPage/TeamIntroSection/TeamSection';
    ...
    <div>
        ...
        <div className="relative z-10 flex flex-row items-center justify-center h-full bg-black bg-opacity-50 text-white text-center ">
          ...
          <div className='flex flex-col item-center flex-1 lg:justify-center lg:items-center  backdrop-blur-lg bg-green-800 bg-opacity-15  h-full justify-center text-center gap-4' style={{ clipPath: 'ellipse(90% 90% at 50% 50%)' }}>
            <p className=" lg:text-2xl text-xs mb-6 lg:max-w-[70vh]">At InsureCow, we are committed to transforming rural economies through innovation, financial empowerment, and sustainable development. Partner with us to drive meaningful change, promote financial inclusion, and foster global food security—one farmer at a time.</p>
