...
const Home = () => {
  ...
  return (
    <div className=" lg:h-auto w-auto h-auto overflow-hidden">
      ...
      <BannerGeneral bannerUrl={grassBrandingImage}>
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center h-full bg-black bg-opacity-50 text-white text-center ">
          ...
          <div
            className="flex w-full  flex-col item-center flex-1 lg:justify-center lg:items-center  backdrop-blur-lg  bg-gradient-to-r  from-green-900/80 to-[#16351810]   h-full justify-center text-center "
          ...
          >
            ...
            <div className="flex space-x-4">
              <Link
                href="/about_us"
                className="w-full flex flex-col items-center justify-center lg:flex-col lg:items-center lg:justify-center"
              >
                <button className="px-4 py-2 bg-white hover:bg-gray-200  border-2 rounded-md hover:border-green-800 text-green-600 font-semibold">
                  Learn More
                </button>
              </Link>
            </div>
