    ...
    <section className="pb-10 h-auto lg:h-auto  flex flex-col  lg:flex-col lg:justify-start  lg:items-center items-center justify-center bg-[#F6F4EC] pt-10">
      ...
      <div className='mt-10 w-full h-auto container mx-auto flex flex-col gap-4 lg:flex-row items-start justify-center  mb-5 '>
           ...
           <Swiper
              ...
              <div className="w-full lg:max-h-[20vh] rounded-lg  relative flex flex-col lg:flex-col lg:justify-start lg:items-start">
                <Image
              ...
              <div className='flex flex-row lg:flex-row items-start justify-between w-full px-5 py-3'>
                ...
                <div className='text-green-700 text-xl font-bold'>{portfolio.investment_period}</div>
              </div>

              <div className='flex flex-row lg:flex-row items-start justify-between w-full px-5 py-3'>
                <div className='text-xl font-semibold'>Return</div>
                <div className='text-green-700 text-xl font-bold'>{portfolio.expected_return_min}% - {portfolio.expected_return_max}%</div>
              </div>

              <div className='flex flex-row lg:flex-row items-start justify-between w-full px-5 py-3'>
                <div className='text-xl font-semibold'>Total Return</div>
                <div className='text-xm font-bold text-green-700'> {formatToBDT(parseInt(portfolio.total_return_min))} - {formatToBDT(parseInt(portfolio.total_return_max))}</div>
              </div>
