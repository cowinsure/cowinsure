...
const GallerySection = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative container mx-auto mt-20 flex flex-col justify-center items-center lg:flex-col lg:justify-center lg:items-center w-full lg:h-[70vh] h-auto p-5"
    >
      <BackgroundImageLayer
        imageUrl={farm.src}
        opacity={0.1}
          ...
          {galleryData.map((item, index) => (
            <SwiperSlide key={item.id}>
              <div
                ...
                className="relative mt-2 mb-5 mr-3 ml-3 aspect-[3/2] shadow-md shadow-gray-800 rounded-lg lg:w-[350px] lg:sh-auto cursor-pointer group"
              ...
              >
                <Image
                  ...
                  alt={item.title}
                  fill
                  className="rounded-md  object-center transition-transform"
